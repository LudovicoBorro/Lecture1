...
class GestoreOrdini:
    ...
    def stampa_riepilogo(self):
        ...
        for prodotto, quantita in self.get_statistiche_prodotti():
...
def test_modulo():
    ...
    ordini = [
        ...
        ], ClienteRecord("Mario Rossi", "mariorossi@gmail.it", "Gold")),
        Ordine([
            RigaOrdine(ProdottoRecord("Laptop", 1200.0), 1),
            RigaOrdine(ProdottoRecord("Mouse", 10.0), 2),
            RigaOrdine(ProdottoRecord("Tablet", 500.0), 1),
            RigaOrdine(ProdottoRecord("Cuffie", 250.0), 1)
        ], ClienteRecord("Fulvio Bianchi", "fulvio@gmail.it", "Gold")),
        Ordine([
            RigaOrdine(ProdottoRecord("Laptop", 1200.0), 2),
            RigaOrdine(ProdottoRecord("Mouse", 10.0), 2)
        ], ClienteRecord("Giuseppe Averta", "giuseppe@polito.it", "Silver")),
        Ordine([
            RigaOrdine(ProdottoRecord("Tablet", 900.0), 1),
            RigaOrdine(ProdottoRecord("Cuffie", 10.0), 2)
        ], ClienteRecord("Carlo Masone", "carlo@gmail.it", "Gold")),
        Ordine([
            RigaOrdine(ProdottoRecord("Laptop", 1200.0), 1),
            RigaOrdine(ProdottoRecord("Mouse", 10.0), 3)
        ], ClienteRecord("Francesca Pistilli", "francesca@gmail.it", "Bronze"))
    ]
